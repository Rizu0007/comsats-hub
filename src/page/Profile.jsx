...
const Profile = () => {
  ...
  return (
   ...
   Sign out
       ...
       <button type='submit' className='w-full bg-stone-700 text-white uppercase px-7 py-7 text-sm font-medium rounded shadow-md hover:bg-orange-600 translate duration-200 ease-out hover:shadow-lg active:bg-red-300'>
